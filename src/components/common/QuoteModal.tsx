...
export default function QuoteModal({ 
  ...
  return (
    <AppModal 
      ...
      hideHeader
    >
      <div className="flex flex-col md:flex-row -m-5 min-h-[500px]">
        {/* Left Side - High-Impact Image */}
        <div className="hidden md:block md:w-1/3 lg:w-2/5 relative overflow-hidden min-h-[500px]">
          <Image 
        ...
        <div className="w-full md:w-2/3 lg:w-3/5 p-6 lg:p-10 bg-white relative">
          <button 
            onClick={onClose}
            className="absolute top-6 right-6 p-2 text-gray-300 hover:text-secondary transition-colors cursor-pointer"
          >
              ...
              <FormProvider {...methods}>
                <form onSubmit={methods.handleSubmit(onSubmit)} className="space-y-5">
                  ...
                  <button 
                    ...
                    className="w-full py-5 inline-flex items-center justify-center gap-3 bg-primary text-white font-bold tracking-widest text-xs rounded-lg transition-all duration-500 hover:bg-secondary shadow-xl cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {isSubmitting ? (
