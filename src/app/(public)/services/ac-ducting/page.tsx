      ...
      <section className="relative h-[45vh] flex items-center justify-center overflow-hidden bg-neutral-900">
        ...
        <div className="relative z-10 text-center space-y-8 max-w-5xl px-6">
          ...
          <h1 className="text-3xl lg:text-5xl font-bold text-white leading-tight tracking-tight">
            AC & <span className="text-primary">Ducting.</span>
          </h1>
          <p className="text-base lg:text-lg text-gray-300 max-w-xl mx-auto leading-relaxed font-normal">
            Efficient HVAC systems and precision ducting for optimal air quality and temperature management.
          </p>
        </div>
      </section>
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <h2 className="text-2xl lg:text-4xl font-bold text-secondary tracking-tight leading-tight">
                  Breathe <span className="text-primary">Easy.</span>
                </h2>
              </div>
              <p className="text-base text-neutral-600 leading-relaxed font-normal">
                We design and install high-performance air conditioning systems that ensure a comfortable environment for your employees while maintaining energy efficiency.
              </p>
              <div className="grid sm:grid-cols-2 gap-8">
                {[
                  { icon: Fan, title: "Precision Airflow", desc: "Balanced ducting design for uniform cooling across all zones." },
                  { icon: Settings, title: "Energy Efficient", desc: "Optimized HVAC solutions to reduce operational costs." },
                  { icon: Thermometer, title: "Zoned Control", desc: "Independent temperature management for different office areas." },
                  { icon: ShieldCheck, title: "Air Quality", desc: "Advanced filtration to keep the workspace healthy." }
                ].map((item, i) => (
      ...
      <section className="py-16 lg:py-24 bg-neutral-950 text-white relative overflow-hidden">
        ...
        <div className="max-w-[1440px] mx-auto px-6 lg:px-12 relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-8 lg:gap-10 relative">
            {[
              { icon: Wind, step: "01", title: "Heat Load Analysis", desc: "Calculating the cooling requirements for each room." },
              { icon: Settings, step: "02", title: "Duct Design", desc: "Drafting the most efficient path for air distribution." },
              { icon: Hammer, step: "03", title: "Commissioning", desc: "Expert installation and final testing for efficiency." }
            ].map((item, i) => (
        ...
        <div className="max-w-[1440px] mx-auto px-6 lg:px-12">
          <div className="bg-neutral-50 rounded-[64px] p-12 lg:p-24 flex flex-col items-center text-center space-y-10 border border-neutral-100 shadow-premium">
            <div className="space-y-6">
              ...
              <h2 className="text-3xl lg:text-5xl font-bold text-secondary tracking-tight">Stay <span className="text-primary">Cool.</span></h2>
              <p className="text-gray-500 text-base lg:text-lg font-normal max-w-xl mx-auto">
                Consult our HVAC specialists for your office environment needs.
              </p>
            </div>
