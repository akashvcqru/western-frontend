    ...
    <main className="bg-white">
      ...
      <section className="relative h-[45vh] flex items-center justify-center overflow-hidden bg-neutral-900">
        ...
        <div className="relative z-10 text-center space-y-8 max-w-5xl px-6">
          ...
          <h1 className="text-5xl lg:text-8xl font-bold text-white leading-[0.95] tracking-tight animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-200">
            Office <span className="text-primary">Interiors.</span>
          </h1>
          <p className="text-xl lg:text-2xl text-gray-300 max-w-2xl mx-auto leading-relaxed font-medium animate-in fade-in slide-in-from-bottom-12 duration-1000 delay-500">
        ...
        <div className="max-w-[1440px] mx-auto px-6 lg:px-12">
          <div className="bg-neutral-50 rounded-[64px] p-12 lg:p-24 flex flex-col items-center text-center space-y-10 border border-neutral-100 shadow-premium">
            <div className="space-y-6">
              ...
              <h2 className="text-4xl lg:text-7xl font-bold text-secondary tracking-tight">Ready to build your <br /><span className="text-primary">dream office?</span></h2>
