      ...
      <section className="relative h-[45vh] flex items-center justify-center overflow-hidden bg-neutral-900">
        ...
        <div className="relative z-10 text-center space-y-8 max-w-5xl px-6">
          ...
          <h1 className="text-3xl lg:text-5xl font-bold text-white leading-tight tracking-tight">
            Vinyl <span className="text-primary">Flooring.</span>
          </h1>
          <p className="text-base lg:text-lg text-gray-300 max-w-xl mx-auto leading-relaxed font-normal">
            High-performance, waterproof, and acoustically silent flooring for high-traffic office environments.
          </p>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-24 lg:gap-32 items-stretch">
            <div className="space-y-8">
              ...
              <p className="text-base text-neutral-600 leading-relaxed font-normal">
                Vibrant, durable, and cost-effective—vinyl is the versatile choice for modern, high-traffic commercial spaces where hygiene and maintenance are key.
              </p>
              <div className="grid sm:grid-cols-2 gap-8">
                {[
                  { icon: Droplets, title: "100% Waterproof", desc: "Ideal for cafeterias, pantries, and breakrooms." },
                  { icon: Wind, title: "Sound Absorbent", desc: "Reduces footfall noise for a quieter office atmosphere." },
                  { icon: ShieldCheck, title: "Antimicrobial", desc: "Easy-to-clean surfaces that promote workplace hygiene." },
                  { icon: Maximize2, title: "Versatile Designs", desc: "Hundreds of patterns from wood-grain to stone textures." }
                ].map((item, i) => (
      ...
      <section className="py-16 lg:py-24 bg-neutral-950 text-white relative overflow-hidden">
        ...
        <div className="max-w-[1440px] mx-auto px-6 lg:px-12 relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-8 lg:gap-10 relative">
            {[
              { icon: Layers, step: "01", title: "Screed Prep", desc: "Ensuring a perfectly smooth base for the vinyl overlay." },
              { icon: Droplets, step: "02", title: "Adhesive Application", desc: "Using high-grade adhesives for a permanent bond." },
              { icon: Sparkles, step: "03", title: "Rolling & Finish", desc: "Ensuring zero bubbles and perfect seam welding." }
            ].map((item, i) => (
        ...
        <div className="max-w-[1440px] mx-auto px-6 lg:px-12">
          <div className="bg-neutral-50 rounded-[64px] p-12 lg:p-24 flex flex-col items-center text-center space-y-10 border border-neutral-100 shadow-premium">
            <div className="space-y-6">
              ...
              <h2 className="text-3xl lg:text-5xl font-bold text-secondary tracking-tight">The smart <span className="text-primary">Choice.</span></h2>
              <p className="text-gray-500 text-base lg:text-lg font-normal max-w-xl mx-auto">
                Discover why vinyl is the most popular choice for modern corporate offices.
              </p>
            </div>
