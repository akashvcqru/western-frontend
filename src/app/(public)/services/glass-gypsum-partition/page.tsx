    ...
    <main className="bg-white">
      ...
      <section className="relative h-[45vh] flex items-center justify-center overflow-hidden bg-neutral-900">
        <Image 
          ...
          alt="Glass and Gypsum Partitions"
          fill
          priority
        ...
        <div className="relative z-10 text-center space-y-8 max-w-5xl px-6">
          ...
          <h1 className="text-3xl lg:text-5xl font-bold text-white leading-tight tracking-tight">
            Glass & <span className="text-primary">Gypsum.</span>
          </h1>
          <p className="text-base lg:text-lg text-gray-300 max-w-xl mx-auto leading-relaxed font-normal">
            Blending the openness of glass with the solidity of gypsum for the perfect balance of collaboration and focus.
          </p>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-24 lg:gap-32 items-stretch">
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <h2 className="text-2xl lg:text-4xl font-bold text-secondary tracking-tight leading-tight">
                  Elegance meets <span className="text-primary">Durability.</span>
                </h2>
              </div>
              <p className="text-base text-neutral-600 leading-relaxed font-normal">
                Our hybrid systems combine toughened glass for visual connectivity and moisture-resistant gypsum boards for structural integrity and superior fire safety.
              </p>
              <div className="grid sm:grid-cols-2 gap-8">
                {[
                  { icon: Sun, title: "Natural Light", desc: "Maximizing daylight penetration to boost mood and energy levels." },
                  { icon: Music, title: "Sound Control", desc: "Gypsum cores provide excellent STC ratings for private meeting rooms." },
                  { icon: ShieldCheck, title: "Safety First", desc: "Fire-rated materials and high-impact resistance glass panels." },
                  { icon: Construction, title: "Seamless Finish", desc: "Perfectly smooth gypsum joints and slim glass profiles." }
                ].map((item, i) => (
            ...
            <div className="relative h-full min-h-[600px] rounded-[48px] overflow-hidden shadow-2xl shadow-neutral-200">
              <Image 
                ...
                alt="Glass/Gypsum Partition Design"
                fill
      ...
      <section className="py-16 lg:py-24 bg-neutral-950 text-white relative overflow-hidden">
        ...
        <div className="max-w-[1440px] mx-auto px-6 lg:px-12 relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-8 lg:gap-10 relative">
            {[
              { icon: Eye, step: "01", title: "Visual Design", desc: "Drafting the balance of transparency and solid walls." },
              { icon: ShieldCheck, step: "02", title: "Material Prep", desc: "Preparing toughened glass and high-grade gypsum." },
              { icon: Hammer, step: "03", title: "Precision Fit", desc: "Expert installation with clean seals and perfect joints." }
            ].map((item, i) => (
        ...
        <div className="max-w-[1440px] mx-auto px-6 lg:px-12">
          <div className="bg-neutral-50 rounded-[64px] p-12 lg:p-24 flex flex-col items-center text-center space-y-10 border border-neutral-100 shadow-premium">
            <div className="space-y-6">
              ...
              <h2 className="text-3xl lg:text-5xl font-bold text-secondary tracking-tight">Ready to clear <span className="text-primary">the vision?</span></h2>
              <p className="text-gray-500 text-base lg:text-lg font-normal max-w-xl mx-auto">
                Get a customized quote for your glass and gypsum partition project today.
              </p>
            </div>
