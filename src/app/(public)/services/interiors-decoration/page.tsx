    ...
    <main className="bg-white">
      ...
      <section className="relative h-[45vh] flex items-center justify-center overflow-hidden bg-neutral-900">
        <Image 
          ...
          alt="Interior Decoration Excellence"
          fill
          priority
          ...
          <div className="grid lg:grid-cols-2 gap-24 lg:gap-32 items-stretch">
            <div className="space-y-8">
              ...
              <div className="grid sm:grid-cols-2 gap-8">
                {[
                  { icon: Brush, title: "Texture & Finishes", desc: "Curating tactile surfaces that define the character of your office." },
                  { icon: Lightbulb, title: "Lighting Design", desc: "Strategic illumination to enhance mood and productivity." },
                  { icon: Component, title: "Custom Artwork", desc: "Bespoke decorative elements that reflect your brand story." },
                  { icon: Layers, title: "Material Palette", desc: "Premium selection of fabrics, woods, and modern composites." }
                ].map((item, i) => (
            ...
            <div className="relative h-full min-h-[600px] rounded-[48px] overflow-hidden shadow-2xl shadow-neutral-200">
              <Image 
                src="https://images.unsplash.com/photo-1556912177-f51b0c2f1c41?q=80&w=2070&auto=format&fit=crop"
                alt="Interior Decoration Detail"
                fill
      ...
      <section className="py-16 lg:py-24 bg-neutral-950 text-white relative overflow-hidden">
        ...
        <div className="max-w-[1440px] mx-auto px-6 lg:px-12 relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-8 lg:gap-10 relative">
            {[
              { icon: Palette, step: "01", title: "Concept Phase", desc: "Defining the color palette and mood for your interior space." },
              { icon: Component, step: "02", title: "Selection", desc: "Choosing premium materials and decorative elements." },
              { icon: Sparkles, step: "03", title: "Execution", desc: "Meticulous installation and finishing for a perfect look." }
            ].map((item, i) => (
