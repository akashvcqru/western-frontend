      ...
      <section className="relative h-[45vh] flex items-center justify-center overflow-hidden bg-neutral-900">
        ...
        <div className="relative z-10 text-center space-y-8 max-w-5xl px-6">
          ...
          <h1 className="text-6xl lg:text-8xl font-bold text-white leading-[0.95] tracking-tight">
            Solid Wall <span className="text-primary">Partitions.</span>
          </h1>
          <p className="text-xl lg:text-2xl text-gray-300 max-w-2xl mx-auto leading-relaxed font-medium">
            High-density, durable wall systems designed for executive offices and secure zones.
          </p>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-24 lg:gap-32 items-stretch">
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <h2 className="text-3xl lg:text-6xl font-bold text-secondary tracking-tight leading-tight">
                  Uncompromised <span className="text-primary">Security.</span>
                </h2>
              </div>
              <p className="text-xl text-neutral-600 leading-relaxed font-medium">
                Our solid wall partitions provide the highest level of acoustic isolation and physical strength, making them ideal for conference rooms and private suites.
              </p>
              <div className="grid sm:grid-cols-2 gap-8">
                {[
                  { icon: VolumeX, title: "Extreme Soundproofing", desc: "Multi-layered insulation for total auditory privacy." },
                  { icon: ShieldAlert, title: "Fire Resistance", desc: "Meets global safety standards for commercial buildings." },
                  { icon: Layers, title: "Premium Finishes", desc: "Available in laminates, veneers, or acoustic fabrics." },
                  { icon: Lock, title: "Structural Rigidity", desc: "Built to withstand the most demanding office environments." }
                ].map((item, i) => (
            ...
            <div className="relative h-full min-h-[600px] rounded-[48px] overflow-hidden shadow-2xl shadow-neutral-200">
              <Image 
                ...
                alt="Solid Wall Partition Design"
                fill
      ...
      <section className="py-16 lg:py-24 bg-neutral-950 text-white relative overflow-hidden">
        ...
        <div className="max-w-[1440px] mx-auto px-6 lg:px-12 relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-8 lg:gap-10 relative">
            {[
              { icon: Lock, step: "01", title: "Secure Planning", desc: "Defining the security and acoustic needs of your space." },
              { icon: Layers, step: "02", title: "Core Build", desc: "Installing high-density cores and structural frames." },
              { icon: Sparkles, step: "03", title: "Final Finish", desc: "Applying the selected premium finish for a solid look." }
            ].map((item, i) => (
        ...
        <div className="max-w-[1440px] mx-auto px-6 lg:px-12">
          <div className="bg-neutral-50 rounded-[64px] p-12 lg:p-24 flex flex-col items-center text-center space-y-10 border border-neutral-100 shadow-premium">
            <div className="space-y-6">
              ...
              <h2 className="text-4xl lg:text-7xl font-bold text-secondary tracking-tight">Built for <span className="text-primary">Longevity.</span></h2>
              <p className="text-gray-500 text-lg lg:text-xl font-medium max-w-2xl mx-auto">
                Discuss your project requirements with our structural interior experts.
              </p>
            </div>
