...
export default function AdminCataloguesPage() {
  ...
  const handlePdfFile = (file: File) => {
    ...
    if (file.size > 1024 * 1024) {
      addToast({ title: "File Too Large", message: "PDF brochure exceeds the 1 MB limit.", variant: "error" });
      return;
    }    const reader = new FileReader();
    reader.onloadend = () => {
      if (typeof reader.result === "string") {
          ...
          <form id="edit-catalogue-form" onSubmit={methods.handleSubmit(handleFormSubmit)} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <span className="text-[8px] text-gray-400 mt-0.5 text-center">Only PDF files (Max 1 MB)</span>
